		...
		<div class="tab-content">
			<div class="tab-pane active" id="findID">
				<div class="col-sm-6 mb-sm-20" id="fidBox">
					...
					<input class="form-control input-lg" type="text" name="memail" id="femail" max="40" min="1" required="required" placeholder="이메일을 입력해 주세요" />
			...
			<div class="tab-pane" id="findPW">
				<div class="col-sm-6 mb-sm-20">
					<input class="form-control input-lg" type="text" name="memail" id="femail" max="40" min="1" required="required"	placeholder="아이디를 입력해 주세요" />
